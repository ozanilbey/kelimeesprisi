$(document).ready(function() {
    ...
    $.getJSON( './posts.json', function(data) {
        ...
        for(i = 0; i < keys.length; i++) {
            ...
            $('#postContainer').append('<div class="' + postData['type'] + ' post"><a href="https://www.facebook.com/photo.php?fbid=' + postID + '" target="_blank"><div class="wrapper"><img src="posts/' + postID + '.jpg" alt="' + postData['script'] + '" /></div></a><div class="credits"><b>Gönderen:</b> <a href="https://www.facebook.com/' + postData['source']['facebook_id'] + '" target="_blank">' + postData['source']['fullname'] + '</a></div></div>');
        }
